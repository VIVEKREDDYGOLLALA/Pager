...
def run_script(script_name, doc_type=None, num_docs=None, languages=None, output_folder=None, cpus=None, dpi=None, timeout=None, log_file=None):
    ...
    try:
        ...
        if script_name == "shoonya_extract.py" and doc_type and num_docs is not None:
            ...
            # Run textline_fill_shoonya.py with languages
...
if __name__ == "__main__":
    ...
    parser.add_argument("--languages", type=str, required=True, help="Space-separated languages for textline_fill_shoonya.py (e.g., 'urdu kashmiri bengali')")
