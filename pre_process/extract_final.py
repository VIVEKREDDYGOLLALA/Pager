...
base_folder = r'BBOX_val'
base_folder_2 = r'BBOX_val' 
json_file_path = r'input_jsons/magazines_jsonns/Assamese_Magazines_4274.json'
input_folder = r'BBOX_val'
base_folder_3 = r'BBOX_val'  
